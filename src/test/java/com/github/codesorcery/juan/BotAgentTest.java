...
public class BotAgentTest {
    ...
    @Test
    public void checkNoOsAndDeviceInfo() {
        ...
        final ParsedUserAgent parsed = UserAgentParser.withoutPlayStoreDeviceList().parse(input);
        Validators.validateOS(parsed.os(), "", "", "", "");
        Validators.validateDeviceInfo(parsed.device(), "", "");
        Validators.validateAgent(parsed.agent(),
