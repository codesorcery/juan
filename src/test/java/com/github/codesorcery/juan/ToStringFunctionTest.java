...
public class ToStringFunctionTest {
    ...
    public void tokenizedUserAgent() {
        ...
        assertThat(toStringResult, containsString("systemTokens=[[VersionedToken[value='iPhone', version=''], VersionedToken[value='CPU iPhone OS', version='10.3.2 like Mac OS X']], [VersionedToken[value='KHTML, like Gecko', version='']]]"));
        assertThat(toStringResult, containsString("browserTokens=[VersionedToken[value='Mozilla', version='5.0'], VersionedToken[value='AppleWebKit', version='603.2.4'], VersionedToken[value='FxiOS', version='7.5b3349'], VersionedToken[value='Mobile', version='14F89'], VersionedToken[value='Safari', version='603.2.4']]"));
